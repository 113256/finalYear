...
//require('includes/getRecentDate.php');
...
$movieInfoQueryGen = "SELECT * FROM `movieinfo` WHERE 1=1 AND releaseDate = '$formattedRecentDate'";
...
<div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class = "container-fluid" >
            	<div class = "jumbotron">
					<h1>Subtitles for recently released movies </h1>
					<p>Showing movies released in <?php echo $formattedRecentDate;?></p>
					<p><?php 
					...
					?></p>
					 ...
					 <form class="form-inline" action = "recent.php" method = "get">
