...
$movieInfoQueryGen = "SELECT * FROM `movieinfo` AS i INNER JOIN `intheatres` AS t on i.movieId = t.movieId WHERE 1=1";
...
if(isset($_GET['searchName'])){
	...
	$movieInfoQueryGen .= " AND t.movieId LIKE '%$search%'";
}
...
<div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class = "container-fluid" >
            	<div class = "jumbotron">
					<h1>Subtitles for movies currently in theatres </h1>
					...
					?></p>
					 ...
					 <form class="form-inline" action = "theatre.php" method = "get">
					...
					<form class = "form-inline" action = "movieShowtimes.php" method = "get">
						<label>Display showtimes for a movie (with location and date)</label>
						<div class = "form-group">
